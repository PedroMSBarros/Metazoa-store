    ...
    <footer className="bg-[#2C1A0E] text-[#C8D4A0]/60">
      ...
      <section id="contato" className="py-20 px-6 text-center bg-gradient-to-br from-[#1A3028] to-[#0D1F1A]">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          ...
          <a href="https://www.instagram.com/metazoa_store/" target="_blank" rel="noreferrer" className="border border-white/30 text-white px-6 py-3 rounded text-sm font-medium flex items-center gap-2 hover:border-white hover:bg-white/5 transition-colors">
