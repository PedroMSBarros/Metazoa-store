    ...
    <footer className="bg-[#2C1A0E] text-[#C8D4A0]/60">
      ...
      <section id="contato" className="py-20 px-6 text-center bg-gradient-to-br from-[#1A3028] to-[#0D1F1A]">
        ...
        <h2 className="font-serif text-4xl font-light text-white mb-3">
          Pronto para <span className="italic text-[#4A8C1C]">começar?</span>
        </h2>
        <p className="text-white/60 max-w-md mx-auto mb-8">Entre em contato pelo WhatsApp e tire todas as suas dúvidas. Atendemos de segunda a sábado.</p>
        <div className="flex gap-4 justify-center flex-wrap">
          <a href="https://wa.me/5511971526750?text=Olá! Vim pelo site e gostaria de saber mais sobre os peixes." target="_blank" rel="noreferrer" className="bg-[#25D366] text-white px-6 py-3 rounded text-sm font-medium flex items-center gap-2 hover:bg-[#1ebe5d] transition-colors">
          ...
          <a href="https://instagram.com/metazoa_store" target="_blank" rel="noreferrer" className="border border-white/30 text-white px-6 py-3 rounded text-sm font-medium flex items-center gap-2 hover:border-white hover:bg-white/5 transition-colors">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <h4 className="text-xs font-medium tracking-widest uppercase text-[#C8D4A0] mb-4">Navegação</h4>
          <ul className="flex flex-col gap-2">
            <li><Link to="/" className="text-sm hover:text-[#4A8C1C] transition-colors">Início</Link></li>
            ...
            <li><Link to="/sobre" className="text-sm hover:text-[#4A8C1C] transition-colors">Sobre nós</Link></li>
            <li><Link to="/cuidados" className="text-sm hover:text-[#4A8C1C] transition-colors">Cuidados</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2">
            <li><Link to="/catalogo" className="text-sm hover:text-[#4A8C1C] transition-colors">Água Doce</Link></li>
            ...
            <li><Link to="/catalogo" className="text-sm hover:text-[#4A8C1C] transition-colors">Acessórios</Link></li>
          </ul>
        </div>
      </div>
