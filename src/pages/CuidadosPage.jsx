...
const dicas = [
  ...
  { num: '07', icon: '🧪', titulo: 'Teste da agua', texto: 'Teste regularmente os parametros da agua: pH, amonia, nitrito e nitrato. Kits de teste sao baratos e essenciais.' },
  { num: '08', icon: '🪸', titulo: 'Decoracao', texto: 'Use substrato e decoracao adequados para cada especie. Alguns peixes precisam de esconderijos para se sentir seguros.' },
  { num: '09', icon: '🩺', titulo: 'Saude dos peixes', texto: 'Observe seus peixes diariamente. Comportamento estranho, manchas ou nadadeiras danificadas podem indicar doencas.' },
]
    ...
    <div className="bg-[#F4F1E1] min-h-screen">
      ...
      <div className="pt-24 pb-20 px-6 max-w-6xl mx-auto">
        ...
        <motion.div className="mb-12" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <p className="text-[#7A6A52] mt-3 max-w-xl">Tudo que voce precisa saber para manter seu aquario saudavel e seus peixes felizes por muito tempo.</p>
        </motion.div>
        ...
        <motion.div className="mt-16 bg-[#2C1A0E] rounded-2xl p-8 text-center" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.5 }}>
          <h2 className="font-serif text-3xl font-light text-[#C8D4A0] mb-3">Ainda tem duvidas?</h2>
          <p className="text-[#C8D4A0]/60 mb-6">Nossa equipe esta pronta para te ajudar pelo WhatsApp!</p>
